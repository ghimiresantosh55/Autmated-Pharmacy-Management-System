'''
model for register, save and change user
'''
...
class UserAccountManager(BaseUserManager):
    '''
    model for user account manager if it is superuser or not
    '''
...
class User(AbstractBaseUser, PermissionsMixin):
    '''
    model for create and save user
    '''
    GENDER_TYPE = (
        (1, "Male"),
        (2, "Female"),
    ...
    user_type = models.PositiveIntegerField(choices=USER_TYPE,
                                         help_text="where 1=system user, 2 = customer")                          

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_party_clearance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='party_payment.partypayment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('party_payment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='party_payment_details', to='party_payment.partypayment')),

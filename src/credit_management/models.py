...
from src.core_app.models import PaymentMode, CreateInfoModel
...
class CreditClearance(CreateInfoModel):
    ...
    sale_main = models.ForeignKey(SaleMain, on_delete=models.PROTECT, related_name = "credit_clear")
